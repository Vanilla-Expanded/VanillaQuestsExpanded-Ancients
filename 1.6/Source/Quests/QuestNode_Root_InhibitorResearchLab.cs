...
{
    public class QuestNode_Root_InhibitorResearchLab : QuestNode_Site
    {
        public override SitePartDef QuestSite => InternalDefOf.VQEA_InhibitorResearchLabSite;
        ...
        protected override void RunInt()
        {
            ...
            if (PrepareQuest(out var map, out var points, out var tile))
            {
                ...
                if (site != null)
                {
                    ...
                    {
                        mapParent = site,
                        inSignalSuccess = QuestGenUtility.HardcodedSignalWithQuestID("site.VQE_CoreUninstalled"),
                        inSignalFail = QuestGenUtility.HardcodedSignalWithQuestID("site.VQE_CoreDestroyed"),
                        questBuilding = InternalDefOf.VQEA_MutagenInhibitorCore
                    };
